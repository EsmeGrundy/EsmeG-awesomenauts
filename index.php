...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="js/entities/Fish.js"></script>
        <script type="text/javascript" src="js/entities/narwhal.js"></script>
        <script type="text/javascript" src="js/entities/Unicorn.js"></script>
        ...
        <script type="text/javascript" src="js/entities/TeamCreep2.js"></script>
        <script type="text/javascript" src="js/entities/HUD.js"></script>
        <script type="text/javascript" src="js/entities/SpearThrow.js"></script>
        <script type="text/javascript" src="js/entities/Whirlpool.js"></script>
        ...
        <script type="text/javascript" src="js/entities/Bubble.js"></script>
